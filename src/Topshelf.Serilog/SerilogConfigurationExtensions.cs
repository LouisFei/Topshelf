...
namespace Topshelf
{
    ...
    public static class SerilogConfigurationExtensions
    {
        ...
        /// </summary>
        public static void UseSerilog(this IHostConfigurator configurator)
        {
        ...
        /// </summary>
        public static void UseSerilog(this IHostConfigurator configurator, LoggerConfiguration loggerConfiguration)
        {
        ...
        /// </summary>
        public static void UseSerilog(this IHostConfigurator configurator, ILogger rootLogger)
        {
